...
\begin{itemize}
\item{Fast panorama stitching for high-quality panoramic images on mobile phones \cite{Xiong2010}}
\item{Automatic Panorama Image Stitching using Invariant Features \cite{Brown2006}}
\item{Video Stitch Algorithm Based on Dynamic Foreground Extraction \cite{Zhang2009}}
\item{Efficient Video Panoramic Image Stitching Based on an Improved Selection of Harris Corners and a Multiple-Constraint Corner Matching \cite{Zhu2013}}
\item{Stitching Video from Webcams \cite{Zheng2008}}
\end{itemize}
