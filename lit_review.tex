...
\label{lit_sec:1}
In order to find the most suited image stitching algorithm for the current task multiple existing image
stitching algorithms were taken into account, out of these four image stitching algorithms were selected
